...
class AuthSourceCreatorPlugin implements AuthenticationSourceCreatorPlugin, InitializablePlugin {
  ...
  private static final var GUIDEWIRE_AB_AUTHENTICATION_CLIENT_KEY = "guidewire.ab.authentication.client"
  ...
  private function initializeCredentials() {
    ...
    var credentialsKey = String.format(GUIDEWIRE_AB_AUTHENTICATION_CLIENT_KEY, new Object[]{product})
