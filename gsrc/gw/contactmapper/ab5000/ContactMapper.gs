  ...
  override property get Mappings() : Set<PropertyMapping> {
    return {
        ...
        fieldMapping(ABContact#CreateStatus)
            .withMappingDirection(TO_XML),
        fieldMapping(ABContact#Levy_Ext),
        fieldMapping(ABContact#BLOCode_Ext),
        fieldMapping(ABContact#VendorAvailability),

        fieldMapping(ABContact#AltPhone_Ext),
        fieldMapping(ABContact#AltPhoneCountry_Ext),
        fieldMapping(ABContact#AltPhoneExtension_Ext),
        fieldMapping(ABContact#DoingBusinessAs_Ext),
        fieldMapping(ABContact#Backupwithholding_Ext),

        //ABVendorCompany
        fieldMapping(ABCompanyVendor#ShopLocationCode_Ext),
